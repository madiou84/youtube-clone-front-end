...
export default function SideBar({data, sideBarTitle, iconClassName, children, ...rest}: SideBarProps) {
    let content;
    if (children) {
        content = children
    } else {
        content = <>
            ...
            {data.map((item: any, index: number) => (
                <SideBarItem key={index} className="flex text-sm" active={item.active}>
