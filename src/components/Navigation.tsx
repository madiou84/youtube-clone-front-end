    ...
    return (
        <div className="bg-white">
            ...
            <header className="relative">
                <nav aria-label="Top" className="mx-auto max-w-screen px-4 sm:px-4 lg:px-4">
                                ...
                                <form className="flex items-center">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center py-2.5 px-4 text-sm bg-gray-100/60 font-medium text-white rounded-r border-y border-r border-gray-300
                                            focus:outline-outline outline-offset-2 outline-1 -dark:bg-gray-600 -dark:hover:bg-gray-700 -dark:focus:ring-gray-800"
                                    >
